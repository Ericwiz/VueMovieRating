  ...
  <nav class="bg-[#191517] z-50 drop-shadow-2xl fixed w-full">
    ...
    <div class="flex justify-between text-white py-6 px-4 sm:px-8 md:px-16">
      ...
      <div class="flex justify-between gap-12 lg:gap-20">
        <h1 class="text-lg xs:text-2xl lg:text-3xl 2xl:text-6xl">
          Vue <span class="text-pink-700 -ml-2">Movies</span>
        </h1>
    ...
    <!-- Mobile Menu -->
    <div
      class="md:hidden z-50 bg-[#191517] px-8 pt-4 w-full sm:w-4/6 h-screen text-white absolute"
      :class="[showMobileMenu ? '-right-[100%]' : 'right-0', 'transition-all duration-500']"
    >
      <div class="flex space-x-10 text-lg text-white">
        <RouterLink
          ...
          to="/"
          active-class="active"
          class="uppercase text-gray-100 hover:text-gray-300 transition-all duration-300"
          >Home</RouterLink
        >
        <RouterLink
          @click="showMobileMenu = !showMobileMenu"
