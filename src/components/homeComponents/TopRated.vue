...
<template>
  <div class="bg-[#110e0f] px-4 sm:px-8 md:px-16 py-10">
    ...
    <div class="flex py-12">
      <RouterLink
        to="/catalog"
        class="uppercase text-lg 2xl:text-4xl bg-gradient-to-r from-pink-600 via-pink-700 to-pink-800 px-4 2xl:px-6 py-2 2xl:py-4 rounded-md text-white mx-auto"
      >
